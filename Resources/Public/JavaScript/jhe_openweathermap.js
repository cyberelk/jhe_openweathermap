...
window.onload = function(){
	...
	let jheopenweathermap = document.getElementById('tx_jheopenweathermap');
	
	if(jheopenweathermap){
		let weatherDataArr = document.getElementById('weatherDataArr').value;
		let xhr = new XMLHttpRequest();
		let url = '?type=19710613';
